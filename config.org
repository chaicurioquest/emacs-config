...
;; Redirect backup files to device specific default directory
(setq backup-directory-alist '((".*" . "~/.emacs.d/backups"))
      version-control nil           ;; Don't use numbered backups
      delete-old-versions t          ;; Optional, safe cleanup
      make-backup-files t            ;; Still create simple backup ~ files
      backup-by-copying t)           ;; Avoid file renaming issues

;; Device-specific autosave directory under default-directory
