...
(use-package org-noter-pdftools
  ...
  (with-eval-after-load 'pdf-annot
    (add-hook 'pdf-annot-activate-handler-functions
              (lambda ()
                (run-with-timer 0.1 nil #'org-noter-pdftools-jump-to-note)))))
#+END_SRC

#+BEGIN_SRC emacs-lisp
;; -----------------------------
;; Namespace Keybindings for Citar & Org-Noter
;; -----------------------------
(define-prefix-command 'my/citar-noter-map)
(global-set-key (kbd "C-c i") 'my/citar-noter-map)

(define-key my/citar-noter-map (kbd "a") #'my/open-paper-and-note)
(define-key my/citar-noter-map (kbd "c") #'my/citar-insert-or-create-note)
(define-key my/citar-noter-map (kbd "p") #'my/pdf-insert-selection-to-note)
#+END_SRC
