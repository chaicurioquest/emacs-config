...
(use-package org
  ...
  ;; Default to biblatex with authoryear for LaTeX exports
  (setq org-cite-export-processors '((latex biblatex "backend=biber,style=authoryear"))) 
  ;; Global bib file (list for multiple if needed) 
  (setq org-cite-global-bibliography '("~/wspace/org/notes/include/references.bib"))  
