...
| C-c i s            | my/save-pdf-region-to-datestamp              | Save selected PDF region as image to note             | pdf-view-mode          |
| C-c i S            | my/save-pdf-region-to-datestamp (whole-page) | Save entire PDF page as image to note                 | pdf-view-mode          |
...
(with-eval-after-load 'pdf-view
  ;; Image capture from PDF
  ;;  Current workflow: Use mouse to select region, then ~C-c i s~ to save as image
