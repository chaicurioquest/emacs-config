...
;; Set TEXINPUTS to include the absolute path to your org/notes/ root (via default-directory) for LaTeX inputs
(setenv "TEXINPUTS" (concat default-directory ":" (getenv "TEXINPUTS")))
