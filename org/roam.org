...
** ACTIVE Org-Attach for Roam
#+BEGIN_SRC emacs-lisp
;; ── Org-Attach: roam-scoped, UUID-based, refile-safe ─────────
;; Scoped here because org-attach-id-dir is roam-specific.
;; Non-roam org files use [[file:images/...]] or file-local overrides.
(setq org-attach-id-dir
      (expand-file-name "attachments/" org-roam-directory))
(setq org-attach-use-inheritance t)
(setq org-attach-auto-tag nil)
(setq org-attach-store-link-p 'attach)
#+END_SRC
...
(use-package org-roam
  ...
  (setq org-roam-completion-everywhere t
        ...
        (concat "${title:*} "
                ...
                " "
                (propertize "${filetitle:40}" 'face 'shadow)))
  ...
  ;; CHANGE: add attachments/ to existing dolist
    (dolist (d (list org-roam-directory
                 org-roam-dailies-directory
                 (expand-file-name "attachments/" org-roam-directory)))
                    (make-directory d t))

  ;; Define ${filetitle} accessor for display template — not built-in, must be declared
  (cl-defmethod org-roam-node-filetitle ((node org-roam-node))
    "Return the #+TITLE of the file containing NODE."
  ...
  ;; Direct Org-Roam v2 startup (Replaces obsolete org-roam-mode-hook)
  (org-roam-db-autosync-mode 1))
#+END_SRC
...
(setq org-roam-capture-templates
      `(("d" "default" plain ,(my/load-template "template/roam-default.org")
        ...
        ("l" "literature" plain ,(my/load-template "template/roam-literature.org")
         :target (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "") :unnarrowed t) 
...
(defun my-org-roam-tag-add ()
  ...
  (interactive)
  (let ((selected-tag (completing-read "Select tag: " (my-org-read-filetags))))
...
(defun my-org-roam-tag-remove ()
  ...
  (interactive)
  (let ((selected-tag (completing-read "Remove tag: "
