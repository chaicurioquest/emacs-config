...
(setq org-roam-capture-templates
        `(("d" "default" plain
           ...
           :unnarrowed t)
         ("f" "fleeting" entry  ;; Changed to 'entry' for subheading; use 'plain' for bullets if preferred
         "* %<%H:%M> %?"  ;; Simple body: Timestamped subheading + cursor; no full template load to avoid headers
         :target (file+olp "../fleeting.org" ("Fleeting Captures"))  ;; Appends here; file relative to org-roam-directory
         :empty-lines 1  ;; Space before new entry
         :unnarrowed t)
          ("p" "permanent" plain
